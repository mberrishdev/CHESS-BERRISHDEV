...
function onClickFunction(id) {
    ...
    if (checker == 1 && activePiece == true) {
        ...
        for (var index = 2; index < returnBoard.length; index++) {
            ...
            if (returnBoard[index].item1.indexOf(NoSpace + concatenate(horizontal, Colon, vertical) + NoSpace) == -1) {
                counter++;
            }
        }
    ...
    if (checker == 1 && activePiece == true) {
        ...
        //document.getElementById(id).firstChild.alt.split(Underscore)[0]
...
function pieceMove(possibleMoveArray) {
    ...
    for (var cheker = 1; cheker < possibleMoveArray.length; cheker++) {
        if (possibleMoveArray[cheker] != 0 && possibleMoveArray[cheker] != undefined) {
            ...
            if (possibleMoveArray[cheker][1] == "SrartPosition") {
                color = "Yellow";
            }
            if (possibleMoveArray[cheker][1] == "Kill") {
                color = "Red";
            }
            if (possibleMoveArray[cheker][1] == "Free") {
                color = "Green";
            }
            if (possibleMoveArray[cheker][1] == "Castle") {
                color = "Green";
            }
            if (possibleMoveArray[cheker][1] == "Promotion") {
                color = "Green";
            }
